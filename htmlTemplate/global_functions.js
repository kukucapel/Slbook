$(document).ready(function() {
  ...
  function change_style(id){
    ...
    const color_mass = {
      blue:'global_styles_blue.css', 
      black:'global_styles_black.css', 
      white:'global_styles_white.css'
    };
...
function show_mobile_menu(){
  ...
  if(ms_state == 0){
    ...
    button.style.backgroundImage='url(tools/mobile_menu_hover.png)';
  ...
  if(ms_state == 1){
    ...
    button.style.backgroundImage='url(tools/mobile_menu.png)';
